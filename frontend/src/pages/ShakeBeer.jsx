...
const FilterableProductList = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row p-6 mt-20 gap-6 bg-black text-white">
      ...
      <h1 className="text-center text-4xl font-bold text-gray-300 mb-6">SHAKE & BEER</h1>
