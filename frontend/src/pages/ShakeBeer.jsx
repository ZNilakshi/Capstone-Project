...
const brands = ["Any Brand","LION","DCSL BREWERIES","HEINEKEN","ANCHOR","TIGER","BISON","DCSL BEER" ];
  ...
  if (loading) return (
    <div className="flex items-center justify-center h-screen bg-black">
      <div className="py-20 text-center text-white">
        ...
        <p className="mt-4 text-xl font-light">Loading our exquisite shake and beer collection...</p>
      </div>
    </div>
  );
        ...
        <div className="relative w-full mb-8 overflow-hidden rounded-xl">
          ...
          <div className="absolute inset-0 z-20 flex items-center p-8 md:p-12">
            <div className="max-w-2xl">
              <h1 className="mb-4 text-4xl font-bold text-white md:text-5xl">Premium Shake & Beer Collection</h1>
