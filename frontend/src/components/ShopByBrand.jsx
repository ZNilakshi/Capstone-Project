    ...
    return (
        <div className="bg-black text-white px-4 py-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-4">
                <button onClick={() => navigate("/brand/rockland")}>
                ...
                <button onClick={() => navigate("/brand/idl")}>
                    <div className="flex justify-center">
                        <img
                            src="/idl-logo.png"
                            alt="IDL Logo"
                ...
                <button onClick={() => navigate("/brand/dcsl")}>
                    <div className="flex justify-center">
                        <img
                            src="/DCSL_Logo.png"
                            alt="DCSL Logo"
                ...
                <button onClick={() => navigate("/brand/mendis")}>
                    <div className="flex justify-center">
                        <img
                            src="/mendis_logo.png"
                            alt="Mendis"
                ...
                <button onClick={() => navigate("/brand/lion")}>
                    <div className="flex justify-center">
                        <img
                            src="/lion-logo.png"
                            alt="Lion"
                ...
                <button onClick={() => navigate("/brand/heineken")}>
                    <div className="flex justify-center">
                        <img
